...
def main(argv):
  ...
  try:
    ...
    start_datetime = datetime(month=8, day=6, year=2013, hour=13)
    end_datetime = datetime(month=8, day=6, year=2013, hour=14)
    event = {
   'summary': 'Knuth[1] lunch',
   'location': 'Better Being Underground, NYC',
   'start': {
   ...
   'end': {
    ...
    created_event = service.events().insert(calendarId='alyssa.frazee@gmail.com', body=event).execute()

    print created_event['id']

    ## HERE: write the event and calendar ID's into a file.
